...
# Adversarial training for SST-2
CUDA_VISIBLE_DEVICES=1 bash scripts/train_adv_and_test_few_shot_roberta.sh 32 sst2 roberta-base mvp 20 1e-5 max mean max mean configs/templates_sst2.yaml configs/verbalizer_sst2.yaml mvp_adv textfooler train -1 0.95 0.05 1 l2 1 ./data/sst2/64-13 64