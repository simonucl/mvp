...
CUDA_VISIBLE_DEVICES=0 bash scripts/test_icl.sh 1 sst2 meta-llama/Llama-2-7b-hf icl_attack configs/templates_sst2_icl.yaml configs/verbalizer_sst2.yaml icl_attack 0
