...
nohup bash scripts/train_adv_and_test_few_shot.sh 8 sst2 roberta-large mvp 20 1e-5 max mean max mean configs/templates_sst2.yaml configs/verbalizer_sst2.yaml mvp_adv textfooler train -1 0.95 0.05 1 l2 1 ./data/sst2/64-13 64 > ./checkpoints/sst2/roberta-large/model_mvp_13_mvp_seed_13_16/logs_trainer.txt 2>&1 &