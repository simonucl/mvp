...
CUDA_VISIBLE_DEVICES=0 nohup bash scripts/test_icl.sh 8 sst2 meta-llama/Llama-2-7b-hf icl configs/templates_sst2_icl.yaml configs/verbalizer_sst2.yaml textfooler 0 > ./logs/run_icl_flash.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=0 nohup bash scripts/test_ralm.sh 8 sst2 meta-llama/Llama-2-7b-hf retrieval_icl configs/templates_sst2_icl.yaml configs/verbalizer_sst2.yaml textfooler 0 > ./logs/run_ralm.log 2>&1 &

CUDA_VISIBLE_DEVICES=1 nohup bash scripts/test_ralm_1.sh 8 sst2 meta-llama/Llama-2-7b-hf retrieval_icl configs/templates_sst2_icl.yaml configs/verbalizer_sst2.yaml textfooler 0 > ./logs/run_ralm_1.log 2>&1 &